...
class ContainerLink(ProcessEvent):
    ...
    def process_default(self, event):
        ...
        """
        self.logger.debug('ContainerLink::process_default')
        # call base method
        super(ContainerLink, self).process_default(event)
    
    def process_IN_MOVED_TO(self, event):
        """
        process 'IN_MOVED_TO' events 
        """
        self.logger.debug('ContainerLink::process_IN_MOVED_TO')
        super(ContainerLink, self).process_default(event)
    ...
    def mkdir_dir_for_register(self, dir):
        """
